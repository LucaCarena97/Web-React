...
import fideos from "../../json/alimentos/fideos.json";
import { CategoriasA } from "../botones/CategoriasA";
import { WhatsApp } from "../botones/WhatsApp";
import { useState } from "react";

export function Fideos() {
  ...
  const filtro = fideos.filter((item) =>
    ...
    <main className="font-quicksand">
      ...
      <section className="flex justify-center select-none animate__animated animate__flipInX products">
        <table className="table-fixed mt-5 border-2 border-blue-300">
          <thead>
            <tr className="border-2 border-yellow-200 text-lg bg-gray-100 boton-color">
