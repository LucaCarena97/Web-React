...
import alicante from "../../json/alimentos/alicante.json";
import { CategoriasA } from "../botones/CategoriasA";
import { WhatsApp } from "../botones/WhatsApp";
import { useState } from "react";

export function Alicante() {
  ...
  const filtro = alicante.filter((item) =>
    ...
    <main className="font-quicksand">
      ...
      <section className="flex justify-center select-none animate__animated animate__zoomIn products">
        <table className="table-fixed mt-5 border-2 border-blue-300">
          <thead>
            <tr className="border-2 border-blue-500 text-lg bg-green-200 boton-color">
