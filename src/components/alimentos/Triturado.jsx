...
import tomate from "../../json/alimentos/tomate.json";
import { CategoriasA } from "../botones/CategoriasA";
import { WhatsApp } from "../botones/WhatsApp";
import { useState } from "react";

export function Triturado() {
  ...
  const filtro = tomate.filter((item) =>
    ...
    <main className="font-quicksand">
      ...
      <section className="flex justify-center select-none">
        <table className="table-fixed mt-5 border-2 border-blue-300">
          <thead>
            <tr className="border-2 border-blue-400 text-lg bg-red-400 boton-color">
