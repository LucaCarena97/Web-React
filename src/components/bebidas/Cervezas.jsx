import cervezas from "../../json/bebidas/cervezas.json";
...
export function Cervezas() {
  ...
  const filtro = cervezas.filter((item) =>
    ...
    <main className="font-quicksand">
      ...
      <section className="flex justify-center select-none animate__animated animate__zoomIn products">
        <table className="table-fixed mt-5 border-2 border-blue-300">
          <thead>
            <tr className="border-2 border-blue-500 text-lg bg-yellow-200 boton-color">
