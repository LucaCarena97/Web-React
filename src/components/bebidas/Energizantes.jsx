import energizantes from "../../json/bebidas/energizantes.json";
...
export function Energizantes() {
  ...
  const filtro = energizantes.filter((item) =>
    ...
    <main className="font-quicksand">
      ...
      <section className="flex justify-center select-none animate__animated animate__flipInX products">
        <table className="table-fixed mt-5 border-2 border-blue-300">
          <thead>
            <tr className="border-2 border-blue-500 text-lg bg-gray-200 boton-color">
